...
public class CourseRVAdapter extends RecyclerView.Adapter<CourseRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseRVAdapter.ViewHolder holder, int position) {
        ...
        holder.courseNameTV.setText(courseRVModal.getVehicleName());
        holder.coursePriceTV.setText("Rs."+courseRVModal.getVehiclePrice());
        Picasso.get().load(courseRVModal.getVehicleImg()).into(holder.courseIV);
