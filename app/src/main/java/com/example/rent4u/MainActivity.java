...
public class MainActivity extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface{
    ...
    private void displayBottomSheet(CourseRVModal courseRVModal){
        ...
        courseNameTV.setText(courseRVModal.getVehicleName());
        courseDescTV.setText(courseRVModal.getVehicleDescription());
        courseSuitedForTV.setText(courseRVModal.getBestSuitedFor());
        coursePriceTV.setText("Rs."+courseRVModal.getVehiclePrice());
        Picasso.get().load(courseRVModal.getVehicleImg()).into(courseIV);

        editBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this,EditCourseActivity.class);
                i.putExtra("vehicle",courseRVModal);
                startActivity(i);
            }
        });
        ...
        viewDetailsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.setData(Uri.parse(courseRVModal.getVehicleLink()));
                startActivity(i);
            }
        });
